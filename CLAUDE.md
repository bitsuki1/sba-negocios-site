...
- **`caixa-de-saida/para-unidade-sba/`** (criado 2026-08-26) — o que é **decisão comercial**, e não do site, sai por aqui para a **área comercial da SBA**. Ordem do dono: *"roteie para a área comercial"*. Este repo **deposita**, nunca escreve no repo da unidade (D201: o auxiliar não co-monta o repo de NEGÓCIO). Padrão de nome: `AAAA-MM-DD_sba-negocios-site_<slug>.md`.
