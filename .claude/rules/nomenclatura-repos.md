...
**Casos que já casam:** unidade = `<unidade>-unidade-de-negocios` (raiz 1ª ✅). **Auxiliar de portfólio** (sem unidade dona única, ex.: `portfolio-automacoes`) NÃO leva prefixo de unidade.
